...
We also have the stain‑from‑H&E prediction pipelines <d-cite key="Latonen.2024">: even when models achieve good correlations, they are learning to reproduce the measurement noise of IF, not necessarily the underlying biology. 
