...
{% include figure.liquid loading="eager" path="assets/img/segmentation_and_annotation/mt_after_filtering_embedding_Visium_HD_Human_Colon_Cancer.png" class="img-fluid rounded z-depth-1" %}
