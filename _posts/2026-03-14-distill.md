...
We'll use [Enrichmap](https://github.com/secrierlab/EnrichMap) <d-cite key="Celik.2025"></d-cite> for this. Compared to standard methods like `scanpy.tl.score_genes`, Enrichmap adds three things that matter for spatial data:
