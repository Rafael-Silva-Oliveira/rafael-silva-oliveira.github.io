...
You can find more detailed information on fine-tuning and how to use H&E embeddings to improve model performance in the [Novae documentation](https://prism-oncology.github.io/novae/tutorials/he_usage/). For this tutorial, we will use the `zero_shot` parameter to compute representations. This leverages the pre-trained model's learned representations to cluster cells without requiring task-specific training (or fine-tuning to be more concrete).
