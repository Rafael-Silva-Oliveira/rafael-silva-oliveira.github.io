...
For cell type annotation on spatial datasets, there are several routes one can choose from. Check out this review for an more in depth overview of cell-type deconvolution methods in spatial transcriptomics <d-cite key="GaspardBoulinc.2025"></d-cite>.
