...
For unsupervised approaches (i.e. without the scRNA reference dataset), one can use TACIT <d-cite key="huynh_deconvolution_2025"></d-cite> in R,  which annotates cells using predefined signatures without training data across diverse tissues.
