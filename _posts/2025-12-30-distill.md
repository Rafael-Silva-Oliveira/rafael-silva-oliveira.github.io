...
Now, lets read the count data. In this case, I am already providing the TPM counts, which were converted from FPKM (original data, can be found here https://www.cbioportal.org/study/summary?id=sclc_ucologne_2015). 
{% highlight python linenos %}
try:
