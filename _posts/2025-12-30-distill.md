...
date: 2025-12-17
featured: true
thumbnail: assets/img/subtyping/sclc_info.png
...
In this tutorial, we will be using the python [cNMF package](https://github.com/dylkot/cNMF), which can be used for both scRNA and bulk RNA data.
